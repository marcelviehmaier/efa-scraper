...
public class ScraperService {
    ...
    public List<Connection> loadConnetions(String origin, String departure, long timestamp, String transportationTypes, int routeType, int departureArrival) {
        ...
        try (final WebClient webClient = new WebClient()) {
            ...
            final List<HtmlRadioButtonInput> radioButtonDateTimeArrivalDeparture;
            ...
            radioButtonDateTimeArrivalDeparture = form.getRadioButtonsByName("itdTripDateTimeDepArr");
            for (int i = 0; i < radioButtonDateTimeArrivalDeparture.size(); i++){
                radioButtonDateTimeArrivalDeparture.get(i).setChecked(false);
                if(i == departureArrival){
                    radioButtonDateTimeArrivalDeparture.get(i).setChecked(true);
                }
            }
